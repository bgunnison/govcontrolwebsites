# Government Healthcare Control

Standalone source, updater, builder, tests, and deployment tooling for
<https://governmenthealthcarecontrol.com>.

The site uses local healthcare-policy articles and is active in `site_config.py`.
Deployment also requires enabled SSH settings in the ignored top-level `private.py`.
